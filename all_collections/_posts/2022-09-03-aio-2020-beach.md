...
Define the furthest node we can reach from i to be `ans[i]`. It is possible that there are leftover umbrellas which should to place (it never hurts to place more umbrellas). We don't need to apply the skipping process to these umbrellas - we can't go any more forward and going backward is the same as going forward from a previous umbrella. 
